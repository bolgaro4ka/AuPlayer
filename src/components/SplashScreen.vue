<template>
    <div class="splash-screen" :class="{ hide: !visible }">
        <svg class="cookie" xmlns="http://www.w3.org/2000/svg" width="320" height="320" viewBox="0 0 320 320" fill="none">
            <path
        ...
        <svg class="oval" xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300" fill="none">
            <path
        ...
        <div class="splash-content">
            <h2>AuPlayer</h2>
            <p>Free open-source audio player</p>
        </div>
    </div>
</template>
